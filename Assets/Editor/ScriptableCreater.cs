...
public class ItemDataCreateWindow : ScriptableObjectCreater<SO_Param>
{
    [MenuItem("Window/Create/SO_Param")]
    ...
    protected override void SetEachData(SO_Param data, Queue<string> dataQueue)
    {
    }
}